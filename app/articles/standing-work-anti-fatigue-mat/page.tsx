  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">コンクリート床や硬い床では足裏に負担がかかりやすい</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">マットだけでなく、靴・姿勢・作業台高さも確認する</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">体重負担を分散し、足腰の疲労軽減に役立つ</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
          クッション性のあるマットは、足元の硬さを和らげ、体重負担を分散することで、足裏・膝・腰の疲労感対策に役立つ場合があります。立ち位置が固定される作業ほど、効果を実感しやすい傾向があります（感じ方には個人差があります）。
        </p>
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">床からの冷気対策にも使える</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">厚さ17mmタイプはクッション性を重視したい現場に向く</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">450×600・450×900・450×1200・450×1500の使い分け</h3>
        <div className="my-6 overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-100 text-left">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">電子部品・精密機器・静電気を嫌う作業場で検討する</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">エラストマットSTD-IIは工場・レジ・店舗カウンターに向く</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">エラストマットESD-IIは静電気対策が必要な現場に向く</h3>
        <p className="mb-4 leading-relaxed text-gray-800">
        ...
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">工場・倉庫の作業台前</h3>
        <p className="mb-4 leading-relaxed text-gray-800">クッション性重視のTRUSCO足腰マット17mm。作業台の幅に合わせて450×900・450×1200・450×1500を使い分けます。</p>
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">スーパー・コンビニ・店舗レジ下</h3>
        <p className="mb-4 leading-relaxed text-gray-800">エラストマットSTD-II 600×465や、足腰マット450×600など、コンパクトでつまずきにくいサイズが向きます。</p>
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">電子部品・半導体・精密機器の作業場</h3>
        <p className="mb-4 leading-relaxed text-gray-800">エラストマットESD-IIや帯電防止足腰マットなど、導電性・帯電防止仕様のタイプを検討します。作業台・靴・アース環境もあわせて確認します。</p>
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">厨房・油や水がある作業場</h3>
        ...
        <p className="mb-4 leading-relaxed text-gray-800">耐油性・耐水性のある足腰マットやエラストマットを検討します。清掃性・滑りにくさ・端部のつまずきに注意して選びましょう。</p>
        <h3 className="mb-3 mt-6 text-lg font-bold text-gray-900">受付・カウンター・スタンディングデスク</h3>
        <p className="mb-4 leading-relaxed text-gray-800">足腰マット450×600やエラストマットSTD-II 600×465が向きます。見た目・サイズ・つまずきにくさも確認しましょう。</p>
        ...
        <div className="my-8 rounded-lg border border-gray-300 bg-gray-50 p-6">
          <h3 className="mb-3 text-lg font-bold text-gray-900">立ち仕事の足腰対策に使えるマットを確認する</h3>
